...
{
    "distutils": {
        "name": "cython_2d_convol_kernel",
        "sources": [
            "cython_2d_convol_kernel.pyx"
        ]
    },
    "module_name": "cython_2d_convol_kernel"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cython_2d_convol_kernel
#define __PYX_HAVE_API__cython_2d_convol_kernel
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'cython_2d_convol_kernel' */
...
static __Pyx_memviewslice __pyx_f_23cython_2d_convol_kernel_convol2d_kernel_fast(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "cython_2d_convol_kernel"
extern int __pyx_module_is_main_cython_2d_convol_kernel;
int __pyx_module_is_main_cython_2d_convol_kernel = 0;

/* Implementation of 'cython_2d_convol_kernel' */
...
static const char __pyx_k_Cython_apply_kernel_function[] = "Cython apply kernel function.";
...
static PyObject *__pyx_kp_s_Cython_apply_kernel_function;
...
static PyObject *__pyx_pf_23cython_2d_convol_kernel_convol2d_kernel_fast(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image, __Pyx_memviewslice __pyx_v_kernel); /* proto */
...
static PyObject *__pyx_pw_23cython_2d_convol_kernel_1convol2d_kernel_fast(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_23cython_2d_convol_kernel_convol2d_kernel_fast(__Pyx_memviewslice __pyx_v_image, __Pyx_memviewslice __pyx_v_kernel, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_w;
  int __pyx_v_h;
  ...
  int __pyx_v_j;
  float __pyx_v_t;
  __Pyx_memviewslice __pyx_v_imgPadding = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_subImg = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("convol2d_kernel_fast", 0);

  /* "cython_2d_convol_kernel.pyx":5
 * 
 * cpdef unsigned char[:, :] convol2d_kernel_fast(unsigned char [:, :] image, float [:, :] kernel):
 *     print('Cython apply kernel function.')             # <<<<<<<<<<<<<<
 *     # set the variable extension types
 *     cdef int x
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_Cython_apply_kernel_function) < 0) __PYX_ERR(0, 5, __pyx_L1_error)

  /* "cython_2d_convol_kernel.pyx":19
 ...
 */
  ...
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_image, 2, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
  ...
  /* "cython_2d_convol_kernel.pyx":21
 *     resultImg = numpy.zeros_like(image)
 * 
 *     imgPadding = numpy.pad(image, 1, mode='constant')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_pad); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_image, 2, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_mode, __pyx_n_s_constant) < 0) __PYX_ERR(0, 21, __pyx_L1_error)
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_2, __pyx_t_1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(__pyx_t_4, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_imgPadding = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "cython_2d_convol_kernel.pyx":24
 * 
 *     # grab the image and kernel dimensions
 *     h = image.shape[0]             # <<<<<<<<<<<<<<
 *     w = image.shape[1]
 ...
 */
  ...
  /* "cython_2d_convol_kernel.pyx":25
 *     # grab the image and kernel dimensions
 *     h = image.shape[0]
 *     w = image.shape[1]             # <<<<<<<<<<<<<<
 *     kh = kernel.shape[0]
 ...
 */
  ...
  /* "cython_2d_convol_kernel.pyx":26
 *     h = image.shape[0]
 *     w = image.shape[1]
 *     kh = kernel.shape[0]             # <<<<<<<<<<<<<<
 *     kw = kernel.shape[1]
 * 
 */
  __pyx_v_kh = (__pyx_v_kernel.shape[0]);

  /* "cython_2d_convol_kernel.pyx":27
 *     w = image.shape[1]
 *     kh = kernel.shape[0]
 *     kw = kernel.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_kw = (__pyx_v_kernel.shape[1]);

  /* "cython_2d_convol_kernel.pyx":34
 * 
 *     # loop over the image
 *     for y in range(h):             # <<<<<<<<<<<<<<
 *         for x in range(w):
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "cython_2d_convol_kernel.pyx":35
 *     # loop over the image
 *     for y in range(h):
 *         for x in range(w):             # <<<<<<<<<<<<<<
 *             subImg = imgPadding[y: y+kh, x: x+kw]
 ...
 */
    ...
    for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
      ...
      /* "cython_2d_convol_kernel.pyx":36
 *     for y in range(h):
 *         for x in range(w):
 *             subImg = imgPadding[y: y+kh, x: x+kw]             # <<<<<<<<<<<<<<
 *             t = 0
 *             for j in range(kh):
 */
      __pyx_t_5.data = __pyx_v_imgPadding.data;
      __pyx_t_5.memview = __pyx_v_imgPadding.memview;
      __PYX_INC_MEMVIEW(&__pyx_t_5, 0);
      __pyx_t_12 = -1;
      if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_5,
    __pyx_v_imgPadding.shape[0], __pyx_v_imgPadding.strides[0], __pyx_v_imgPadding.suboffsets[0],
    0,
    0,
    &__pyx_t_12,
    __pyx_v_y,
    (__pyx_v_y + __pyx_v_kh),
    0,
    1,
    1,
    0,
...
if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_5,
    __pyx_v_imgPadding.shape[1], __pyx_v_imgPadding.strides[1], __pyx_v_imgPadding.suboffsets[1],
    1,
    1,
    &__pyx_t_12,
    __pyx_v_x,
    (__pyx_v_x + __pyx_v_kw),
    0,
    1,
    1,
    0,
...
__PYX_XDEC_MEMVIEW(&__pyx_v_subImg, 1);
      __pyx_v_subImg = __pyx_t_5;
      __pyx_t_5.memview = NULL;
      __pyx_t_5.data = NULL;

      /* "cython_2d_convol_kernel.pyx":37
 *         for x in range(w):
 *             subImg = imgPadding[y: y+kh, x: x+kw]
 *             t = 0             # <<<<<<<<<<<<<<
 *             for j in range(kh):
 ...
 */
      ...
      /* "cython_2d_convol_kernel.pyx":38
 *             subImg = imgPadding[y: y+kh, x: x+kw]
 *             t = 0
 *             for j in range(kh):             # <<<<<<<<<<<<<<
 *                 for i in range(kw):
 ...
 */
      __pyx_t_12 = __pyx_v_kh;
      __pyx_t_13 = __pyx_t_12;
      for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
        __pyx_v_j = __pyx_t_14;

        /* "cython_2d_convol_kernel.pyx":39
 *             t = 0
 *             for j in range(kh):
 *                 for i in range(kw):             # <<<<<<<<<<<<<<
 *                     t += subImg[j, i] * kernel[j, i]
 * 
 */
        __pyx_t_15 = __pyx_v_kw;
        __pyx_t_16 = __pyx_t_15;
        for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
          __pyx_v_i = __pyx_t_17;

          /* "cython_2d_convol_kernel.pyx":40
 *             for j in range(kh):
 *                 for i in range(kw):
 *                     t += subImg[j, i] * kernel[j, i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          __pyx_t_20 = -1;
          if (__pyx_t_18 < 0) {
            __pyx_t_18 += __pyx_v_subImg.shape[0];
            if (unlikely(__pyx_t_18 < 0)) __pyx_t_20 = 0;
          } else if (unlikely(__pyx_t_18 >= __pyx_v_subImg.shape[0])) __pyx_t_20 = 0;
          if (__pyx_t_19 < 0) {
            __pyx_t_19 += __pyx_v_subImg.shape[1];
            if (unlikely(__pyx_t_19 < 0)) __pyx_t_20 = 1;
          } else if (unlikely(__pyx_t_19 >= __pyx_v_subImg.shape[1])) __pyx_t_20 = 1;
          ...
          __pyx_t_20 = -1;
          if (__pyx_t_21 < 0) {
            __pyx_t_21 += __pyx_v_kernel.shape[0];
            if (unlikely(__pyx_t_21 < 0)) __pyx_t_20 = 0;
          } else if (unlikely(__pyx_t_21 >= __pyx_v_kernel.shape[0])) __pyx_t_20 = 0;
          if (__pyx_t_22 < 0) {
            __pyx_t_22 += __pyx_v_kernel.shape[1];
            if (unlikely(__pyx_t_22 < 0)) __pyx_t_20 = 1;
          } else if (unlikely(__pyx_t_22 >= __pyx_v_kernel.shape[1])) __pyx_t_20 = 1;
          if (unlikely(__pyx_t_20 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_20);
            __PYX_ERR(0, 40, __pyx_L1_error)
          }
          __pyx_v_t = (__pyx_v_t + ((*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_subImg.data + __pyx_t_18 * __pyx_v_subImg.strides[0]) ) + __pyx_t_19 * __pyx_v_subImg.strides[1]) ))) * (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_kernel.data + __pyx_t_21 * __pyx_v_kernel.strides[0]) ) + __pyx_t_22 * __pyx_v_kernel.strides[1]) )))));
        }
      }

      /* "cython_2d_convol_kernel.pyx":42
 *                     t += subImg[j, i] * kernel[j, i]
 * 
 *             resultImg[y,x] = t             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_4 = PyFloat_FromDouble(__pyx_v_t); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 42, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      ...
      __pyx_t_1 = 0;
      __pyx_t_2 = 0;
      if (unlikely(PyObject_SetItem(__pyx_v_resultImg, __pyx_t_3, __pyx_t_4) < 0)) __PYX_ERR(0, 42, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    }
  }

  /* "cython_2d_convol_kernel.pyx":45
 * 
 *     # resultImg = cv2.normalize(resultImg, resultImg, 0,255, cv2.NORM_MINMAX)
 *     return resultImg             # <<<<<<<<<<<<<<
 */
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(__pyx_v_resultImg, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 45, __pyx_L1_error)
  __pyx_r = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("cython_2d_convol_kernel.convol2d_kernel_fast", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  ...
  __pyx_L2:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_imgPadding, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_subImg, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_23cython_2d_convol_kernel_1convol2d_kernel_fast(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_23cython_2d_convol_kernel_1convol2d_kernel_fast(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("convol2d_kernel_fast (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_kernel)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("convol2d_kernel_fast", 1, 2, 2, 1); __PYX_ERR(0, 4, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "convol2d_kernel_fast") < 0)) __PYX_ERR(0, 4, __pyx_L3_error)
      }
    ...
    __pyx_v_image = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_image.memview)) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_kernel = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_kernel.memview)) __PYX_ERR(0, 4, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("convol2d_kernel_fast", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 4, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cython_2d_convol_kernel.convol2d_kernel_fast", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_23cython_2d_convol_kernel_convol2d_kernel_fast(__pyx_self, __pyx_v_image, __pyx_v_kernel);
...
static PyObject *__pyx_pf_23cython_2d_convol_kernel_convol2d_kernel_fast(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image, __Pyx_memviewslice __pyx_v_kernel) {
  ...
  if (unlikely(!__pyx_v_kernel.memview)) { __Pyx_RaiseUnboundLocalError("kernel"); __PYX_ERR(0, 4, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_23cython_2d_convol_kernel_convol2d_kernel_fast(__pyx_v_image, __pyx_v_kernel, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 4, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "cython_2d_convol_kernel.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "cython_2d_convol_kernel.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "cython_2d_convol_kernel.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "cython_2d_convol_kernel._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"convol2d_kernel_fast", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_23cython_2d_convol_kernel_1convol2d_kernel_fast, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_cython_2d_convol_kernel(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cython_2d_convol_kernel},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_Cython_apply_kernel_function, __pyx_k_Cython_apply_kernel_function, sizeof(__pyx_k_Cython_apply_kernel_function), 0, 0, 1, 0},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcython_2d_convol_kernel(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcython_2d_convol_kernel(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cython_2d_convol_kernel(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cython_2d_convol_kernel(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cython_2d_convol_kernel(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cython_2d_convol_kernel' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cython_2d_convol_kernel(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cython_2d_convol_kernel", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cython_2d_convol_kernel) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cython_2d_convol_kernel")) {
      if (unlikely(PyDict_SetItemString(modules, "cython_2d_convol_kernel", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cython_2d_convol_kernel", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cython_2d_convol_kernel");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
